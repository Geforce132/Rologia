package net.geforce.smartwatch.rologia.os;
...
import net.geforce.smartwatch.rologia.gui.screens.BootScreen;
import net.geforce.smartwatch.rologia.gui.screens.Screen;
import net.geforce.smartwatch.rologia.os.apps.App;
import net.geforce.smartwatch.rologia.os.apps.AppStepCounter;
import net.geforce.smartwatch.rologia.os.stats.UserStats;
import net.geforce.smartwatch.rologia.os.tasks.TaskUpdateTime;
...
public class Rologia {
	...
	private void loadApps() {
		...
		System.out.println("loading " + FMLCommonHandler.instance().getSide());
