...
import net.geforce.smartwatch.rologia.gui.components.shapes.ScreenShapeArrowSimple;
import net.geforce.smartwatch.rologia.gui.components.shapes.ScreenShapeRectangle;
import net.geforce.smartwatch.rologia.gui.rendering.Colors;
import net.geforce.smartwatch.rologia.gui.rendering.Images;
