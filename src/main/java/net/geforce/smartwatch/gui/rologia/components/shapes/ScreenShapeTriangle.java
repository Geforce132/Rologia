...
public class ScreenShapeTriangle extends ScreenComponent {
	...
	public ScreenShapeTriangle(int v1x, int v1y, int v2x, int v2y, int v3x, int v3y, Color c1) {
		super((v1x + v2x + v3x) / 3, (v1y + v2y + v3y) / 3); // X-Y coordinates are for the centroid of the triangle.
		vertex1_x = v1x;
		vertex1_y = v1y;
		vertex2_x = v2x;
		vertex2_y = v2y;
	...
	public ScreenShapeTriangle(int v1x, int v1y, int v2x, int v2y, int v3x, int v3y, Color c1, Color c2, Color c3) {
		super((v1x + v2x + v3x) / 3, (v1y + v2y + v3y) / 3); // X-Y coordinates are for the centroid of the triangle.
		vertex1_x = v1x;
		vertex1_y = v1y;
		vertex2_x = v2x;
